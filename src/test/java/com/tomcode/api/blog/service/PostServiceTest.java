...
public class PostServiceTest {
  ...
  public void shouldDeletePost() {
    // given
    CreatePostDTO createPostDto = new CreatePostDTO("Title", "Content", "aGVsbG8=");
    UUID id = postService.createPost(createPostDto);
  ...
  public void shouldCreatePost() {
    // given
    CreatePostDTO dto = new CreatePostDTO("Post", "Lorem ipsum", "aGVsbG8=");
  ...
  void shouldUpdatePost_fieldsAreChanged() {
    // given
    UUID id = postService.createPost(new CreatePostDTO("Old", "Old content", "aGVsbG8="));

    // when
    UpdatePostDTO updated = new UpdatePostDTO("New", "New content", "bmV3");
  ...
  void updatePost_shouldThrow_whenNotFound() {
    ...
    UpdatePostDTO dto = new UpdatePostDTO("T", "C", "Th");
  ...
  void createPost_shouldThrow_whenThumbnailInvalidBase64() {
    CreatePostDTO dto = new CreatePostDTO("Title", "Content", "not@base64!!");
